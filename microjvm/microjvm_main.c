...
int microjvm_main(int argc, char *argv[])
{
#if (CONFIG_SDK_USER_ENTRYPOINT == microjvm_main)
    // Should be called if entry points is microjvm instead of the default you remove NSH
